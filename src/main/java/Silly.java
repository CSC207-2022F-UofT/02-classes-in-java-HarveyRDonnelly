...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param first_string the string that will be the first part of the Silly instance's name.
     * @param second_string the string that will be concatenated onto the first_string object to become the second part
     *                      of the Silly instance's name.
     */
    ...
    public static void main(String[] args) {
        ...
        x.countStatic();
        x.countStatic();
        int[] expected_values = {0, 1, 2, 3}; // Check later
    ...
    public int compareTo(Silly other) {
        ...
        int length_other = (other.toString()).length();
